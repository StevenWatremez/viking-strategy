const explanationMessages = [
  ...
  { title: '🚨 VIKINGS : Préparer sa ville', titleEn: '🚨 VIKINGS: Prepare your city', titleEs: '🚨 VIKINGOS: Preparar la ciudad', titleAr: '🚨 الفايكنغز: تجهيز المدينة', short: 'Héros et troupes', tag: 'COMPRENDRE', tone: 'wait',
    ...
    pl: '🦸 Zostaw 3 najlepszych bohaterów w mieście i zablokuj ich w centrum dowodzenia, aby nie wysłać ich przez pomyłkę. Wyślij WSZYSTKIE wojska do wsparcia sojuszników, zwłaszcza piechotę i łuczników, a obronę swojego miasta zostaw ich posiłkom. Zatrzymanie bohaterów nie oznacza trzymania wojsk w domu! Obserwuj też wojska wracające w trakcie wydarzenia.',
    tr: '🦸 En iyi 3 kahramanınızı şehirde tutun ve yanlışlıkla yürüyüşe göndermemek için Komuta Merkezinde kilitleyin. TÜM birliklerinizi (özellikle piyade ve okçuları) müttefiklere takviye olarak gönderin; şehrinizi onların takviyeleri savunsun. Kahramanları tutmak, evde birlik bırakmak anlamına gelmez! Etkinlik sırasında geri dönen birliklere de dikkat edin.',
  ...
  { title: '🚨 VIKINGS : Lire les rapports', titleEn: '🚨 VIKINGS: Read the reports', titleEs: '🚨 VIKINGOS: Leer los informes', titleAr: '🚨 الفايكنغز: قراءة التقارير', short: 'Les deux contrôles', tag: 'COMPRENDRE', tone: 'wait',
    ...
    pl: '🔎 Po ataku sprawdźcie raport: 1️⃣ Wasz gracz powinien mieć 0 zabójstw w swoim mieście; jeśli nie, sprawdźcie wojska w domu i odeślijcie je. 2️⃣ W prawym górnym rogu cel to 100% zabitych Wikingów; jeśli mniej, zgłoście miasto do R4 w celu korekty posiłków. Przestrzegajcie sygnałów GO przed przesunięciem wojsk.',
...
const uiTranslations = {
  ...
  pl: {
    ...
    card2Title: 'Wyprowadź wszystkie wojska',
    card2Body: '<p>Wyślij swoje wojska jako posiłki do sojuszników i pozwól ich posiłkom bronić twojego miasta. <strong>Zatrzymanie bohaterów nie oznacza trzymania wojsk w domu.</strong></p><p>Wojska w domu mogą zabijać Wikingów zamiast posiłków: twoi sojusznicy tracą okazję do zdobycia punktów.</p>',
    ...
    reportCol1: '<strong>Czy moje własne wojska zabiły Wikingów?</strong><p>Sprawdź wiersz swojego gracza w szczegółach zabójstw. Celem jest <strong>0 zabójstw przez własne wojska w twoim mieście</strong>. Jeśli jakieś widzisz, sprawdź wojska, które zostały lub wróciły do domu, i odeślij je jako posiłki zgodnie z instrukcjami.</p>',
  ...
  tr: {
    ...
    card2Title: 'Tüm birliklerinizi çıkarın',
    card2Body: '<p>Birliklerinizi müttefikleri takviye etmeye gönderin ve şehrinizin onların takviyeleriyle savunulmasını sağlayın. <strong>Kahramanları tutmak, birlikleri evde tutmak anlamına gelmez.</strong></p><p>Evde kalan birlikler takviyeler yerine Vikingleri öldürebilir: bu durumda müttefikleriniz puan kazanma fırsatlarını kaybeder.</p>',
    ...
    reportCol1: '<strong>Kendi birliklerim Viking öldürdü mü?</strong><p>Öldürme ayrıntılarında oyuncu satırınıza bakın. Hedef, <strong>şehrinizde kendi birlikleriniz tarafından 0 öldürmedir</strong>. Görüyorsanız, evde kalan veya dönen birlikleri kontrol edin ve talimatlara göre takviye olarak gönderin.</p>',
